import { Camera, Mesh, Plane, Program, Renderer, Texture, Transform } from 'https://cdn.jsdelivr.net/npm/ogl/dist/ogl.mjs';
...
export class CircularGalleryApp {
  ...
  createMedias(items, bend = 3, textColor, borderRadius, font, aspectRatio) {
    this.mediasImages = items.concat(items); // Double for loop
  ...
  onCheck() {
    ...
    this.scroll.target = (this.scroll.target < 0 ? -1 : 1) * item;
  }
  onResize() {
    this.screen = {
